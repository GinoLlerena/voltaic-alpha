...
Recorded 28 August 2026 from Alpaca Paper account `PA3WZR22ITRR`. No live
endpoint was contacted; the gateway verifies the resolved Paper endpoint
...
Final state: **0 open positions**, equity 100000.00 → 99992.90.

## What this demonstrates, and what it does not

It demonstrates that an approved decision reached the broker as the exact bytes
that were approved, that both legs filled as one strategy, and that local state
reconciles to flat.

It demonstrates nothing about profitability. The round trip realized **-7.10**,
